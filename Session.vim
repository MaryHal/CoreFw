...
set shortmess=aoO
badd +4 src/Audio/SoundStream.h
badd +127 src/Audio/SoundStream.cpp
badd +1 src/Audio/Music.h
badd +1 src/Audio/Music.cpp
badd +1 ~/tmp/SFML/include/SFML/Audio/Music.hpp
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 175 - ((11 * winheight(0) + 12) / 24)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
175
...
wincmd w
argglobal
edit ~/tmp/SFML/include/SFML/Audio/SoundStream.hpp
setlocal keymap=
setlocal noarabic
setlocal autoindent
setlocal balloonexpr=
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 298 - ((14 * winheight(0) + 12) / 25)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
298
...
wincmd w
argglobal
edit ~/tmp/SFML/src/SFML/Audio/Music.cpp
setlocal keymap=
setlocal noarabic
setlocal autoindent
setlocal balloonexpr=
...
wincmd w
argglobal
edit ~/tmp/SFML/src/SFML/Audio/SoundStream.cpp
setlocal keymap=
setlocal noarabic
setlocal autoindent
setlocal balloonexpr=
...
exe '4resize ' . ((&lines * 25 + 26) / 53)
exe 'vert 4resize ' . ((&columns * 97 + 97) / 194)
tabedit ~/tmp/SFML/src/SFML/Audio/SoundFile.hpp
set splitbelow splitright
wincmd _ | wincmd |
vsplit
1wincmd h
...
wincmd w
argglobal
edit ~/tmp/SFML/src/SFML/Audio/SoundFile.cpp
setlocal keymap=
setlocal noarabic
setlocal autoindent
setlocal balloonexpr=
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 241 - ((37 * winheight(0) + 25) / 50)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
241
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 113 - ((42 * winheight(0) + 25) / 50)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
113
...
wincmd w
argglobal
edit ~/code/current/CoreFW/src/System/ResourceCache.cpp
setlocal keymap=
setlocal noarabic
setlocal autoindent
setlocal balloonexpr=
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 72 - ((32 * winheight(0) + 19) / 39)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
72
...
exe '3resize ' . ((&lines * 10 + 26) / 53)
exe 'vert 3resize ' . ((&columns * 97 + 97) / 194)
tabedit ~/code/current/CoreFW/test/TestState.h
set splitbelow splitright
wincmd _ | wincmd |
vsplit
1wincmd h
...
wincmd w
argglobal
edit ~/code/current/CoreFW/test/TestState.cpp
setlocal keymap=
setlocal noarabic
setlocal autoindent
setlocal balloonexpr=
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 92 - ((15 * winheight(0) + 25) / 50)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
92
...
wincmd w
argglobal
edit ~/code/current/CoreFW/src/Audio/SoundBuffer.cpp
setlocal keymap=
setlocal noarabic
setlocal autoindent
setlocal balloonexpr=
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 48 - ((46 * winheight(0) + 25) / 50)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
48
...
wincmd w
argglobal
edit ~/code/current/CoreFW/src/Audio/Sample.cpp
setlocal keymap=
setlocal noarabic
setlocal autoindent
setlocal balloonexpr=
...
wincmd w
argglobal
edit ~/code/current/CoreFW/src/Audio/Sound.cpp
setlocal keymap=
setlocal noarabic
setlocal autoindent
setlocal balloonexpr=
